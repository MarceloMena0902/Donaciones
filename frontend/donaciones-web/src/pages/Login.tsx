        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          <div>
            ...
            <div className="flex items-center gap-3 bg-white border border-[#dccdbb] rounded-xl px-4 py-3 shadow-sm">
              ...
              <input type="email" placeholder="nombre@ejemplo.com" required className="w-full bg-transparent outline-none" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 bg-white border border-[#dccdbb] rounded-xl px-4 py-3 shadow-sm">
              ...
              <input type="password" placeholder="••••••••" required className="w-full bg-transparent outline-none" />
            </div>

            {/* 🔥 NUEVO: olvidar contraseña */}
          ...
          <button type="submit" className="w-full py-3 rounded-xl bg-gradient-to-r from-[#826c43] to-[#e66748] text-white font-semibold shadow-lg hover:scale-[1.02] transition">
            INICIAR SESIÓN
          </button>
        </form>
