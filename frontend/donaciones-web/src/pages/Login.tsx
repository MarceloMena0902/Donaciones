...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await loginWithEmail(cleanEmail, cleanPass);
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f5efe7] to-[#efe7dc] px-4 py-16">
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-3xl shadow-lg border border-white/60 p-10 relative">
